...
var result = {
  ...
  'ENFP': {'mbti': 'ENFP', 'explain': '단조로운 일을 지속해야 할 때 스트레스를 받는 타입!<br>에너지가 많고 아이디어가 풍부한 만큼, 자신의 생각을 충분히 드러낼 수 없는 곳에서 힘이 나지 않는 편이에요😐<br>스트레스 받을 땐 멋지게 풀어버려요! 제가 당신을 위한 스트레스 해소법으로 생각한 게 있는데, 들어보실래요?<br><br><b>저의 추-천</b><br>스트레스 받을 땐 치맥이죠!', 'img' : 'img' : 'assets/images/mbti/ENEN.jpg'},
